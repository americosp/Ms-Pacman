...
public class Exec
{
	...
	public static void main(String[] args)
	{
		...
		exec.runExperiment(studentAttacker, defender, true,_Game.DELAY, 2);
...
//		exec.replayGame("human-v-Legacy2.txt");
     ...
     */
    public void runExperiment(AttackerController attackerController, DefenderController defenderController,boolean visual, int delay, int trials)
    {
		double avgScore = 0;
    	int tick = 0;
